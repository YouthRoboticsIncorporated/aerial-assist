...
#define WINCH_RETRACT_TIMEOUT 4.6
...
#define BALL_TRAP_LEFT_MOTOR_PWM 9
#define BALL_TRAP_RIGHT_MOTOR_PWM 10

#define BALL_TRAP_LEFT_MOTOR_SPEED 0.25
#define BALL_TRAP_RIGHT_MOTOR_SPEED -0.25
